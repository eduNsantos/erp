<div class="container-fluid">
    <div class="row">
        ...
        <div id="current-period" class="btn">
            <span class="initial-date">De {{ date('01/m/Y') }}</span>
            <span class="final-date">à {{ date('t/m/Y') }}</span>
        </div>
    </div>
        ...
        <form action="#">
            <div class="form-row mx-0 px-0">
                <div class="col">
                    ...
                    <input type="date" name="initial_date" id="initial_date" class="form-control" value="{{ date('Y-m-01') }}">
                </div>
                <div class="col">
